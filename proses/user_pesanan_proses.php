...
if(isset($_POST['batal'])){
    ...
    $statement = mysqli_query($connection,"UPDATE tb_transaksi SET UPDATED_AT=TO_DATE('$updated_at','yyyy-mm-dd hh24:mi:ss'), DEL_FLAGE_TRANS='$del_flage_trans' WHERE ID_TRANSAKSI='$id_transaksi'");
    if {
    ...
    $statement = mysqli_query($connection,"UPDATE tb_transaksi SET UPDATED_AT=TO_DATE('$updated_at','yyyy-mm-dd hh24:mi:ss'), ULASAN='$ulasan' WHERE ID_TRANSAKSI='$id_transaksi'");
    if{
